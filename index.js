...
function game() {
   ...
   // for (playerCount=0;playerCount<5;playerCount++)
    if ((isNaN(guessNumber))&&(playerCount<5))// this if condition is to check the if user's input is a number or not.
    ...
    else if(( (guessNumber>20)||(guessNumber<1))&&(playerCount<5))//this if condition is to check if the user's input number is within range
        { 
    ...
    else if((guessNumber>computerNumber)&&(playerCount<5))// for condition that user's input number is bigger than computer random number
       {
    ...
    else if(( guessNumber<computerNumber)&&(playerCount<5))// for condition that user's input number is smaller than computer number
    ...
    else if((guessNumber===computerNumber)&&(playerCount<=5))//for condition that user's input strictly equal to computer number
        {
